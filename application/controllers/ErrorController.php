    ...
    public function errorAction()
    {
        ...
        switch ($errors->type) {
            ...
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_NO_ACTION:
                ...
                break;
            case ($errors->exception instanceof SoftLayer_Soap_Client_Exception && $errors->exception->getMessage() == SoftLayer_Soap_Client::EXCEPTION_NO_API_KEY):
                // application error
                $this->getResponse()->setHttpResponseCode(500);
                $this->view->message = 'No valid API authentication tokens are defined.';
                break;
            default:
                // application error
                $this->getResponse()->setHttpResponseCode(500);
